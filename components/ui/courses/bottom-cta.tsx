        ...
        <section className="bottom-cta-section bg-gray-100 py-16 md:py-20 lg:py-24">
            <div className="max-w-4xl mx-auto px-4 md:px-8 lg:px-16 text-center">
                <div className={`transition-all duration-500 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                    ...
                    {/* CTA Button */}
                    <a
                        href={`https://wa.me/254720611517?text=${encodeURIComponent(`Hi, I would like to request a quote for a custom training solution for my organization. Can you help me get a personalized proposal?`)}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center px-7 py-4 bg-red-500 text-white font-montserrat font-semibold rounded-lg transition-all duration-200 hover:bg-red-600 hover:scale-103 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
                    >
                        Request a Quote
